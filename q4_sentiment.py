...
# REGULARIZATION = [0.1,0.3,0.01,0.03,0.001,0.003,0.0001,0.0003,0.00001,0.00003]
# Load the dataset
...
### YOUR CODE HERE
sorted_results = max(results, key = lambda x:x['dev'])
BEST_REGULARIZATION = sorted_results['reg']
BEST_WEIGHTS = sorted_results['weights']
### END YOUR CODE
